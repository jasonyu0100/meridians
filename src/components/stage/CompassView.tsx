...
export default function CompassView({ mode }: VariablesViewProps) {
  ...
  // `buildActivePhaseSection` folds in the working-machinery substrate so
  ...
  const modeSection = buildActivePhaseSection(narrative, 'variables');
...
// ScenePanel. Resize handle is rendered at the panel's top edge.
