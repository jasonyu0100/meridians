...
export default function StagePalette({
  ...
  const graphNodeNav = useMemo(() => {
    ...
    if (isPhaseMode) {
      ...
      const selectedId = ctx?.type === "mode" && ctx.phaseGraphId === activeId ? ctx.nodeId : null;
  ...
  // ── Phase mode state ─────────────────────────────────────────────────
  // Generation work and loading UI live in PhaseGraphView (mirroring the
            ...
            <>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  // CompassView consumes it on mount.
                  try {
