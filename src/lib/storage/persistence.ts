// Persistence layer — reads/writes narratives, view state, and logs across IndexedDB + localStorage.

import type { NarrativeState, NarrativeViewState, AnalysisJob, ApiLogEntry, SystemLogEntry, SearchQuery } from '@/types/narrative';
import { idbGet, idbPut, idbDelete, idbGetAll, NARRATIVES_STORE, META_STORE, API_LOGS_STORE } from '@/lib/storage/idb';
import { logInfo, logError, logWarning } from '@/lib/core/system-logger';
