...
import { proseShapeDirective } from '@/lib/prompts/paradigm';
...
${direction}
  ...
  <locus>Pick where multiple active dimensions converge — a place, institution, artifact, relationship, ritual, negotiation, operational process, or moment of public/private overlap already touching several open threads, transformations, or rules. Density comes from causal adjacency, not invention.</locus>
  ...
  <restraint>Don't resolve every accumulated state at once. Institutions, relationships, and belief systems resist rapid transformation — escalation produces confusion, denial, procedural slowdown, partial adaptation, and attempts to preserve normalcy, never clean coordination. Consequences propagate indirectly through reputational shifts, institutional adaptation, resource flows, emotional hardening, paranoia, opportunism, and altered strategic assumptions. Some lie dormant across arcs.</restraint>
  <epistemic-divergence>Different actors hold incompatible models; the same event gets divergent readings — read as strength, weakness, betrayal, opportunity, propaganda, sacrifice, or destiny across the cast. Actors act on perceived reality, not objective truth. Lean into this: stale or false beliefs driving action, institutions misclassifying events, reports drifting from reality, systems optimising for false assumptions. Even competent actors carry incomplete maps — prefer suspicion, probabilistic judgment, and provisional cooperation over premature consensus. False beliefs anchoring real action produce accidental escalation, self-fulfilling prophecies, tragic spirals, coordination failures — emergence the engine cannot produce from agreement.</epistemic-divergence>
</brief>`;
  })();
