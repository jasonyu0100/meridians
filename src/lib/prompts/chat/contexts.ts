...
export function buildSceneChatPrompt(
  ...
  return composeChatSystem(
    'scene',
    narrative.title,
    `You are a helpful assistant. The user is working on the story "${narrative.title}" and has scene-level context attached below, but you are free to answer any question they ask — creative, technical, personal, or anything else. Use the story context when the question is about the story; otherwise respond normally without forcing the conversation back to the narrative. Be concise and specific.`,
    [],
    {
      narrative,
      sceneAnchor,
...
export function buildOutlineChatPrompt(
  ...
  return composeChatSystem(
    'outline',
    narrative.title,
    `You are a helpful assistant. The user is working on the story "${narrative.title}" and has a condensed outline attached below, but you are free to answer any question they ask — creative, technical, personal, or anything else. Use the story context when the question is about the story; otherwise respond normally without forcing the conversation back to the narrative. Be concise and specific.`,
    [],
    {
      narrative,
      sceneAnchor,
...
export function buildNarrativeChatPrompt(
  ...
  return composeChatSystem(
    'narrative',
    narrative.title,
    `You are a helpful assistant. The user is working on the story "${narrative.title}" and has deep narrative context attached below (world, characters, threads, scene history up to the current point), but you are free to answer any question they ask — creative, technical, personal, or anything else. Use the story context when the question is about the story; otherwise respond normally without forcing the conversation back to the narrative. When discussing the narrative, be concise and specific. When suggesting directions, consider the existing threads and their maturity.`,
    [],
    {
      narrative,
      sceneAnchor,
...
export function buildFutureChatPrompt(
  ...
  return composeChatSystem(
    'future',
    narrative.title,
    `You are a helpful assistant. The user is working on the story "${narrative.title}" and wants to discuss the FUTURE scenarios on the currently-viewed arc — alternate next-arc unfoldings, each with a logit-based plausibility, a softmax probability over the cohort, and a coordination of named variables firing at different intensities. Two context blocks are attached: a STORY OUTLINE (historical recap so you understand how the world got here) and the FUTURE cohort (the scenarios + the arc's Present coordination for contrast). Be ready to reason about which scenarios are favoured and why, which dials would have to fire for a tail-event scenario to play out, and how the cohort coordinates against the Present.`,
    [
