...
export const PROMPT_LOCATIONS = `<locations hint="PHYSICAL places you can stand in OR scenario theatres / model regions / agent populations the work treats as locatable. Match the register the work establishes.">
