...
> Top-down map of how the whole app connects, current 2026-06-05 (verified against code). Companion to [TREE.md](TREE.md) (the file structure). Read top-to-bottom: **navigation → workspace shell → center views → inspector → topbar/modals → run & output surfaces → data/AI/persistence pipeline.**
...
flowchart LR
    ...
    SP --> T11["learning → LearningPanel (browse question banks)"]
