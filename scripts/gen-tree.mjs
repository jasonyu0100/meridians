...
const ANN = {
  ...
  "src/components/sidebar/MapAnnotator.tsx": "map annotation editor",
  ...
  "src/components/sidebar/InvestigationPanel.tsx": "investigations panel",
...
const DIR_DEFAULT = {
  ...
  "src/components/sidebar/investigations": (n) => `investigations sub-UI: ${stem(n)}`,
