...
> **Implementation spec — Conviction, the Rehearsal card game.** Conviction is the War Room played as a **turn-based card game** on the shipping substrate — threads/stances, **streams/priors**, **merges**, **locations** ([CLAUDE.md](CLAUDE.md)). This doc is implementation-first: the **game loop as a state machine**, and the **type model** that backs it (what we reuse, what's net-new). Vocabulary: [LANGUAGE.md](LANGUAGE.md).
